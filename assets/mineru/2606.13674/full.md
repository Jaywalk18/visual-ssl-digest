...
1Institute of Trustworthy Embodied AI, Fudan University 2Robbyant, Ant Group, 3Hongkong University of Science and Technology

Web page: https://wdrink.github.io/RepWAM
...
![](images/a7c905e3acd0ad9edb20172ac0f0c0971ae781700701b149fd466a495371e972.jpg)
...
```mermaid
graph LR
  A["Image with human figure"] --> B["VAE Encoder"]
  B --> C["VAE Decoder"]
  C --> D["L_recon"]
```
</details>
...
![](images/48ceadef82183cb8676235facc59b3aa97f5381101039f92cefac3f548edcb8c.jpg)
...
```mermaid
graph LR
  A["Image 1"] --> C["Inverse Dynamics"]
  B["Image 2"] --> D["Forward Dynamics"]
  C --> E["L_fwd"]
  D --> E
```
</details>
...
![](images/27cfed13e884b97a09d551aa3414b9d5c2d58da1caffce9dc79797266d9ec166.jpg)
...
```mermaid
graph TD
  A["Vision Foundation Model"] --> B["Visual Tokenizer Encoder"]
  A --> C["Visual Tokenizer Decoder"]
  B --> D["Latent Action Tokenizer Inverse Dynamics"]
  C --> E["Latent Action Tokenizer Forward Dynamics"]
  D --> F["Lfwd"]
  D --> G["Lcons"]
  H["Lalign"] --> A
  I["Lrecon"] --> C
...
(c) Representation Visual-Action Tokenizer  
...
$$
\mathcal {L} _ {\mathrm{rec}} = \lambda_ {1} \| o - \hat {o} \| _ {1} + \lambda_ {\text { perc }} \mathcal {L} _ {\text { perc }} (o, \hat {o}) + \lambda_ {\text { gan }} \mathcal {L} _ {\text { gan }} (\hat {o}), \tag {1}
$$
...
$$
\mathcal {L} _ {\text { align }} = \left\| \operatorname{avg} (W _ {\text { align }} z) - \operatorname{avg} (G (o)) \right\| _ {2} ^ {2}. \tag {2}
$$
...
$$
\ell_ {t} = q _ {\phi} (z _ {t}, z _ {t + 1}),
$$

$$
K _ {t}, \delta_ {t} = f _ {\psi} (z _ {t}, \ell_ {t}), \tag {3}
$$

$$
\hat {z} _ {t + 1} = K _ {t} z _ {t} + \delta_ {t},
$$
...
$$
\mathcal {L} _ {\mathrm{fwd}} = \sum_ {t = 1} ^ {T ^ {\prime} - 1} \left\| \hat {z} _ {t + 1} - z _ {t + 1} \right\| _ {2} ^ {2}, \quad \mathcal {L} _ {\text { cons }} = \sum_ {t = 1} ^ {T ^ {\prime} - 1} \left\| \hat {z} _ {t} - z _ {t} \right\| _ {2} ^ {2}. \tag {4}
$$
...
$$
x _ {\alpha} = (1 - \alpha) \epsilon_ {t: t + k} + \alpha u _ {t: t + k}, \quad \dot {x} _ {\alpha} = u _ {t: t + k} - \epsilon_ {t: t + k}, \tag {6}
$$
...
$$
\mathcal {L} _ {\mathrm{FM}} = \mathbb {E} \left[ \left\| F _ {\theta} ^ {v} (x _ {\alpha}, \alpha , s _ {<   t}) - \dot {x} _ {\alpha} ^ {v} \right\| _ {2} ^ {2} + \lambda_ {a} \left\| F _ {\theta} ^ {a} (x _ {\alpha}, \alpha , s _ {<   t}) - \dot {x} _ {\alpha} ^ {a} \right\| _ {2} ^ {2} \right], \tag {7}
$$
...
![](images/7efe889bb9be3671b668c2bc7b3dc15d13c5a4d28e59a1ae364316083291017c.jpg)

<details>
<summary>bar chart</summary>

| Category | π₀.₅ (%) | Lingbot-VA (%) | Ours-1.3B (%) | Ours-5B (%) |
| :--- | :--- | :--- | :--- | :--- |
...
![](images/d3b0b66362c4d4abdcd2d03d1f02468fcd895958423f5a7bde0247154df330ae.jpg)  
...
<table><tr><td rowspan="2">Metric</td><td colspan="2"> $\pi_{0.5}$  [4]</td><td colspan="2">Motus [3]</td><td colspan="2">Lingbot-VA [20]</td><td colspan="2">Ours 1.3B</td><td colspan="2">Ours 5B</td></tr><tr><td>Easy</td><td>Hard</td><td>Easy</td><td>Hard</td><td>Easy</td><td>Hard</td><td>Easy</td><td>Hard</td><td>Easy</td><td>Hard</td></tr><tr><td>Backbone pretrained</td><td colspan="2">√</td><td colspan="2">√</td><td colspan="2">√</td><td colspan="2">✗</td><td colspan="2">✗</td></tr><tr><td>Average $_{\text{hor}=2}$ </td><td>79.3</td><td>73.0</td><td>85.2</td><td>80.9</td><td>85.3</td><td>86.9</td><td>85.7</td><td>84.0</td><td>87.4</td><td>87.6</td></tr><tr><td>Average $_{\text{hor}=3}$ </td><td>78.6</td><td>67.4</td><td>85.0</td><td>84.2</td><td>89.6</td><td>90.6</td><td>92.0</td><td>85.4</td><td>88.0</td><td>90.4</td></tr><tr><td>Average $_{50}$  Tasks</td><td>82.7</td><td>76.8</td><td>88.7</td><td>87.0</td><td>92.9</td><td>91.6</td><td>86.6</td><td>83.1</td><td>89.3</td><td>88.4</td></tr></table>
...
<table><tr><td rowspan="2">Metric</td><td colspan="2">WAN2.2 VAE [28]</td><td colspan="2">RepViTok (Ours)</td></tr><tr><td>Easy</td><td>Hard</td><td>Easy</td><td>Hard</td></tr><tr><td> $Average_{hor=1}$ </td><td>81.1</td><td>78.4</td><td>86.2</td><td>83.1</td></tr><tr><td> $Average_{hor=2}$ </td><td>75.5</td><td>73.9</td><td>85.7</td><td>84.0</td></tr><tr><td> $Average_{hor=3}$ </td><td>67.2</td><td>68.0</td><td>92.0</td><td>85.4</td></tr><tr><td> $Average_{50 Tasks}$ </td><td>78.0</td><td>76.0</td><td>86.6</td><td>83.1</td></tr></table>
...
<table><tr><td rowspan="2">Model</td><td colspan="4">Eval Seen</td><td colspan="4">Eval Unseen</td><td rowspan="2">PickFruit</td></tr><tr><td>gFVD</td><td>PSNR</td><td>SSIM</td><td>OLS</td><td>gFVD</td><td>PSNR</td><td>SSIM</td><td>OLS</td></tr><tr><td>w/o</td><td>61.01</td><td>18.47</td><td>0.70</td><td>18.82</td><td>72.91</td><td>17.72</td><td>0.67</td><td>14.15</td><td>30%</td></tr><tr><td>Joint Pred</td><td>94.25</td><td>15.24</td><td>0.61</td><td>18.52</td><td>98.77</td><td>15.09</td><td>0.55</td><td>15.22</td><td>20%</td></tr><tr><td>Two Stages (Ours)</td><td>48.23</td><td>22.86</td><td>0.75</td><td>19.87</td><td>58.83</td><td>19.93</td><td>0.74</td><td>16.98</td><td>50%</td></tr></table>
...
![](images/437be71d005ed3fb1900845af2023c353ee6c2311ee3e21eaafded76861dca79.jpg)

![](images/7329bc22f6867c38e6596456968ca07a0428b2db10a1717c1e79940dc4a9a720.jpg)

<details>
<summary>line chart</summary>

| Training step | LAPA  | Ours  |
| ------------- | ----- | ----- |
| 0             | 0.6   | 0.6   |
| 4000          | 0.15  | 0.13  |
| 8000          | 0.14  | 0.11  |
...
![](images/0e14e808b16c8983310e3d6eeae73d5e4d09cb9d638df1df2ca956bad68f3151.jpg)

<details>
<summary>line chart</summary>

| CFG scale | Easy - Ours | Easy - Lingbot-VA | Hard - Ours | Hard - Lingbot-VA | Average - Ours | Average - Lingbot-VA |
| --------- | ----------- | ----------------- | ----------- | ----------------- | -------------- | -------------------- |
| 1.0       | 89.3        | 91.5              | 88.4        | 90.2              | 88.9           | 90.8                 |
| 1.25      | 90.6        | 92.0              | 85.5        | 90.2              | 88.0           | 91.2                 |
| 2.0       | 88.4        | 91.7              | 87.9        | 90.6              | 88.1           | 91.3                 |
</details>
...
![](images/bd77f4dbf8246607104bc96a4a1a7376692463ee8ef4e81332c71d27668c0097.jpg)

<details>
<summary>text_image</summary>

Thanks for living Col. 3:12.
therefore, as God's chosen pe
holy and dearly loved, clou
urselves with compassion,
numility, gentleness and
Thanks for living Col. 3:12.
therefore, as God's chosen pe
holy and dearly loved, clou
urselves with compassion,
